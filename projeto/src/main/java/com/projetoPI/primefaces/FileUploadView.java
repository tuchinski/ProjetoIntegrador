...
import com.projetoPI.repository.DBFile2;
...
public class FileUploadView {
	...
	private DBFile2 dbFileRepository;
...
//        		System.out.print(file.getFileName() + "hello");
        		this.dbFile = new DBFile(fileName, arq.getContentType(), arq.getContents(), "teste");
        		System.out.println(this.dbFile.getFileName() + "123456");
        		System.out.println(this.dbFile.getId());
        		System.out.println(dbFileRepository.save(this.dbFile));
